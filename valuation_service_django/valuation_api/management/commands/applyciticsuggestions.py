...
class Command(BaseCommand):
    ...
    def handle(self, *_args, **options):
        ...
        min_similarity = float(options.get("min_similarity") or 0.95)
        ...
        for item in suggestions_data.get("suggestions", []):
            ...
            for suggestion in item.get("suggestions") or []:
                ...
                if match_type == "keyword_rule":
                    accepted.append({"level": suggestion.get("target_level"), "name": suggestion.get("target_name")})
