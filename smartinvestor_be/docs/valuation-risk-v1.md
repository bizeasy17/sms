...
```powershell
python manage.py prefillvaluationsnapshot --codes-file output/h1_missing_before_2025.txt --trade-date 2026-04-10 --freq D --refresh-policy all --target-report-type H1 --target-fiscal-year 2025 --business-match-topn 3 --profit-buckets both --dry-run
```

确认后正式执行：

```powershell
python manage.py prefillvaluationsnapshot --codes-file output/h1_missing_before_2025.txt --trade-date 2026-04-10 --freq D --refresh-policy all --target-report-type H1 --target-fiscal-year 2025 --business-match-topn 3 --profit-buckets both
```
...
```powershell
python manage.py prefillvaluationsnapshot --codes-file output/tmp_000851.txt --trade-date 2025-09-26 --freq D --refresh-policy all --target-report-type H1 --target-fiscal-year 2025 --business-match-topn 3 --profit-buckets both
python manage.py prefillvaluationsnapshot --codes-file output/tmp_002231.txt --trade-date 2026-01-29 --freq D --refresh-policy all --target-report-type H1 --target-fiscal-year 2025 --business-match-topn 3 --profit-buckets both
```
