...
def _summarize_trade_bucket(trades):
    ...
    max_holding_exits = sum(1 for item in trades if item.get("exit_reason") == "max_holding_days_hit")
    ...
    return {
        ...
        "max_holding_exit_count": max_holding_exits,
...
def run_traditional_value_exit_account_backtest(
    *,
    ...
    if priority_policy not in {"score_desc", "high_price_first", "low_price_first", "deep_discount_first", "low_risk_high_score"}:
