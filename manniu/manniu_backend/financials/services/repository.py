    ...
    def _build_model_instance(
        ...
        if issubclass(model_cls, FinancialIncomeRecord):
            ...
            kwargs.update({
                ...
                'st_borr': normalize_decimal(raw_row.get('st_borr')),
                'lt_borr': normalize_decimal(raw_row.get('lt_borr')),
            ...
            kwargs.update({
                ...
                'n_incr_cash_cash_equ': normalize_decimal(raw_row.get('n_incr_cash_cash_equ')),
            ...
            kwargs.update({
                ...
                'q_dt_roe': normalize_decimal(raw_row.get('q_dt_roe')),
                ...
                'cash_ratio': normalize_decimal(raw_row.get('cash_ratio')),
                'assets_turn': normalize_decimal(raw_row.get('assets_turn')),
                'ocf_to_or': normalize_decimal(raw_row.get('ocf_to_or')),
