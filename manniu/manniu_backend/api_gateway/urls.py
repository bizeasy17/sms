...
urlpatterns = [
	...
	path('indices/composite/fundamentals', views.indices_composite_fundamentals, name='market-analysis-indices-composite-fundamentals'),
	path('indices/composite/close', views.indices_composite_close, name='market-analysis-indices-composite-close'),
	path('indices/<str:index_key>/bars', views.index_bars, name='market-analysis-index-bars'),
	path('indices/<str:index_key>/fundamentals', views.index_fundamentals, name='market-analysis-index-fundamentals'),
