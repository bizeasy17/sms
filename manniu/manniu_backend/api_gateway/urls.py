...
urlpatterns = [
	...
	path('securities/<str:ts_code>/market-evidence', views.security_market_evidence, name='market-analysis-security-market-evidence'),
	path('securities/<str:ts_code>/technical-trend', views.security_technical_trend, name='market-analysis-security-technical-trend'),
