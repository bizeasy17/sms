...
import { IndexTrendModal } from '../../features/index-trend/IndexTrendModal'
import './topbar-index-trend.css'
...
export function TopBar({ onMenu, onSelect, activeSection = 'research' }: TopBarProps) {
	...
	const [indexTrendOpen, setIndexTrendOpen] = useState(false)
	const closeIndexTrend = useCallback(() => setIndexTrendOpen(false), [])
