...
class EarningsSignalSnapshotHistory(models.Model):
    ...
    is_backfill = models.BooleanField(default=False, db_index=True)
    backfill_run_id = models.CharField(max_length=64, blank=True, default="", db_index=True)
    last_error = models.TextField(blank=True, default="")
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["asof_date", "report_type", "created_at"], name="idx_esh_date_rt_ct"),
            models.Index(fields=["is_backfill", "created_at"], name="idx_esh_bf_ct"),
        ]


class EarningsBacktestRun(models.Model):
    """Persist predictive valuation backtest run metadata and outputs."""

    run_key = models.CharField(max_length=64, unique=True, db_index=True)
    batch_key = models.CharField(max_length=64, db_index=True, blank=True, default="")
